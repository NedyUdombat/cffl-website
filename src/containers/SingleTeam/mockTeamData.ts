...
export const mockStandings: Standing[] = [
  {
    rank: 1,
    teamName: "Lagos Lions",
    teamSlug: "lagos-lions",
    gp: 6,
    wins: 5,
    losses: 1,
    pointsFor: 182,
  ...
  {
    rank: 2,
    teamName: "Abuja Eagles",
    teamSlug: "abuja-eagles",
    gp: 6,
    wins: 4,
    losses: 2,
    pointsFor: 154,
  ...
  {
    rank: 4,
    teamName: "Kano Chiefs",
    teamSlug: "kano-chiefs",
    gp: 6,
    wins: 2,
    losses: 4,
    pointsFor: 110,
  ...
  {
    rank: 5,
    teamName: "Enugu Storm",
    teamSlug: "enugu-storm",
    gp: 6,
    wins: 1,
    losses: 5,
    pointsFor: 94,
...
export const mockNews: MockNewsArticle[] = [
  {
    ...
    excerpt:
      "A dominant second-half performance sealed a crucial home victory as the team climbed to second place in the CFFL standings.",
    date: "2026-04-12",
  ...
  },
  {
    ...
    excerpt:
      "Coaches and players gather for the annual two-day training camp ahead of the second half of the season.",
    date: "2026-04-08",
    category: "Training",
  ...
  },
  {
    ...
    excerpt:
      "The team announces signings from across Nigeria, bolstering both the offensive line and defensive backfield.",
    date: "2026-04-02",
    category: "Transfers",
  ...
  },
  {
    ...
    excerpt:
      "In an exclusive interview, the team captain shares his thoughts on the upcoming clash and what the squad has been working on.",
    date: "2026-03-28",
    category: "Interview",
  ...
  },
  {
    ...
    excerpt:
      "Hundreds of fans turned out for the annual community day event, with flag football clinics for children of all ages.",
    date: "2026-03-20",
    category: "Community",
