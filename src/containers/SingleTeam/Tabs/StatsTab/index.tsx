...
const StatsTab = ({ teamId, competitionId }: StatsTabProps) => {
  ...
  return (
    <section className="bg-bg-2">
      <div className="max-w-360 mx-auto py-8 px-6 md:px-14 lg:px-20 flex flex-col gap-6">
        ...
        <div className="bg-white border border-line rounded-2xl overflow-hidden shadow-sm">
          <div className="flex items-center gap-3 px-5 py-3.5 border-b border-line-2 bg-surface-2">
            ...
            <span
              className={`font-mono font-semibold text-sm uppercase tracking-wide-ui ${activeCat.accentColor}`}
            >
              {activeCat.label}
            </span>
