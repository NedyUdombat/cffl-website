  ...
  return (
    <div>
      <div className="flex items-baseline gap-3 mb-4">
        ...
        <h3 className="font-mono font-semibold text-base uppercase tracking-wide-ui text-ink">
          Season Leaders
        </h3>
        <span className="font-mono text-2xs text-muted">Top 5 per category</span>
      </div>
