...
function TeamStandingsPreview({ competition, teamId }: StandingOverviewProps) {
  ...
  return (
    <motion.div variants={fadeUp} className="bg-white p-4 rounded-xl">
      ...
      <button
        type="button"
        className="mt-3 block text-center text-[10px] uppercase tracking-widest text-gray-500 hover:text-red-400 transition-colors"
      >
        Full Table →
      </button>
    </motion.div>
